 ...
 */
@interface OMIDInvidiAdEvents : NSObject
 ...
 */
- (nullable instancetype)initWithAdSession:(nonnull OMIDInvidiAdSession *)session error:(NSError * _Nullable * _Nullable)error;
 ...
 */
- (BOOL)loadedWithVastProperties:(OMIDInvidiVASTProperties *_Nonnull)vastProperties
