 ...
 */
@interface OMIDInvidiAdSessionContext : NSObject
 ...
 * @see OMIDSDK
 */
- (nullable instancetype)initWithPartner:(OMIDInvidiPartner *)partner
...
- (nullable instancetype)initWithPartner:(OMIDInvidiPartner *)partner
                               ...
                               resources:(NSArray<OMIDInvidiVerificationScriptResource *> *)resources
                              contentUrl:(nullable NSString *)contentUrl
               customReferenceIdentifier:(nullable NSString *)customReferenceIdentifier
                                   error:(NSError *_Nullable *_Nullable)error;
