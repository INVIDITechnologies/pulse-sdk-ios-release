 ...
 */
@interface OMIDInvidiAdSession : NSObject

/**
 *  The AdSession configuration is used for check owners.
 */
@property(nonatomic, readonly) OMIDInvidiAdSessionConfiguration *configuration;
/**
 ...
 */
- (nullable instancetype)initWithConfiguration:(OMIDInvidiAdSessionConfiguration *)configuration
                              adSessionContext:(OMIDInvidiAdSessionContext *)context
